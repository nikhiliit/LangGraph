...
def create_gradio_interface():
    ...
    chatbot = gr.ChatInterface(
        chat_with_pdf,
        type="messages",
        title="🔬 Research Paper Analysis Agent v2.0",
        description="Upload a PDF and ask questions about research papers. Supports LaTeX equations. Features evaluator node with ChatOpenAI model to check chatbot response quality. Powered by LangGraph, LangChain & LangSmith.",
